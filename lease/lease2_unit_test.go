...
// TestLease2ImplementsStringer verifies that Lease2 satisfies the fmt.Stringer interface.
func TestLease2ImplementsStringer(t *testing.T) {
	var _ fmt.Stringer = Lease2{}
	var _ fmt.Stringer = (*Lease2)(nil)
}
